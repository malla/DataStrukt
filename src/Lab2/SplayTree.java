...
extends BinarySearchTree<E> implements CollectionWithGet<E>{
	...
	/*
	 * Zig - Rotera 1 steg i högervarv, dvs 
	 * 		 x'		    y' 
	 *		/ \ 	   / \ 
	 *	   y'  C  --> A   x' 
	 *	  / \            /  \
	...
	/*
	 * Zag - Rotera 1 steg i vänstervarv, dvs 
	 *    x'         y' 
	 *   / \        / \ 
	 *  A  y' -->  x' C 
	 *    / \     /\
	...
	/*
	 * ZigZag - Rotera 1 steg i högervarv, 1 steg i vänstervarv, dvs
	 *        x' 			z' 
	 *       / \		   / \ 
	 *      A   y' -->    x'  y' 
	 *         / \ 		 / \  / \ 
	...
	/*
	 * ZagZig - Rotera 2 steg i högervarv, dvs 
	 * 			x' 		 	 z' 
	 * 		   / \ 		   /   \ 
	 * 		  y'  D -->   y'    x' 
	 * 		 / \		 / \   / \ 
	 ...
	 */
	private Entry splayToRoot(Entry e) { // Beöver man faktiskt tilldela root?
