...
/**
 * A minimal implementation of a collection as a singly linked list. The elements
 * are unordered and may contain duplicates. As proposed in Collins book Data
 * Structures and the Java Collections Framework, chapter 7.3.
 * 
 * @author Bror Bjerner
 * @version (070125)
 */
public class LinkedCollection<E> extends AbstractCollection<E> {
	...
	/**
	 * <tt> head </tt> is a referens to the first element in the list.
	 * <tt> head </tt> is <tt> null </tt> in the empty collection.
	 */
	protected Entry head;

	/**
	 * The class of objects used as nodes of the singly linked list
	 */
	...
	/**
	 * Create an iterator over the elements contained in the collection.
	 * 
	...
	/**
	 * Adds an element to the collection. The element added last will be the
	 * first element given by the iterator and the first element added will be
	 * the last given by the iterator.
	 * 
	 * @param element
